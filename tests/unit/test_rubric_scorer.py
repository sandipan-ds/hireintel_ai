...
class TestPromptConstruction:
    ...
    def test_anchors_in_prompt(self):
        ...
        prompt = _build_rubric_prompt("Python", get_rubric("education"), evidence)
...
class TestFormulaEvaluation:
    ...
    def test_skill_formula_gate_times_ratio(self):
        sub_scores = [
        ...
        assert result == pytest.approx(0.8)  # 1.0 * 0.8
...
class TestScoreRequirementWithRubric:
    ...
    def test_full_scoring_flow(self):
        ...
        # Formula: 1.0 * 0.5 = 0.5
        assert trace.normalized_score == pytest.approx(0.5)
        # 10 * 0.5 = 5.0
        assert trace.weighted_score == pytest.approx(5.0)
    ...
    def test_cached_trace_contains_all_fields(self):
        ...
        assert "formula" in d
        assert d["formula"] == "gate * years_ratio"
