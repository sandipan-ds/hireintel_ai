# Baseline-Centric Rank Stability Report — DataScience
...
| :--- | ---: | :---: | :---: |
| **Top-10 Jaccard (Overlap)** | `0.4476` | `≥ 0.60` | ⚠️ Review |
| **Top-50 Jaccard (Overlap)** | `1.0000` | — | — |
| **Worst-Case Max Rank Shift** | `34.0` | `≤ 50.0` | ✅ Pass |
| **Mean Absolute Rank Shift** | `6.4935` | `≤ 15.0` | ✅ Pass |
| **Median Absolute Rank Shift** | `6.4762` | — | — |
| **P95 Absolute Rank Shift** | `12.0119` | — | — |
| **Kendall Tau** | `0.5686` | `≥ 0.60` | ⚠️ Review |
| **Spearman Rho** | `0.6990` | `≥ 0.65` | ✅ Pass |
