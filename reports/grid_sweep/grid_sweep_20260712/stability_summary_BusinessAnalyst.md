# Baseline-Centric Rank Stability Report — BusinessAnalyst

- **Created at:** 2026-07-12T15:23:25Z
...
| :--- | ---: | :---: | :---: |
| **Top-10 Jaccard (Overlap)** | `0.4103` | `≥ 0.60` | ⚠️ Review |
| **Top-50 Jaccard (Overlap)** | `0.6357` | — | — |
| **Worst-Case Max Rank Shift** | `112.0` | `≤ 50.0` | ⚠️ Review |
| **Mean Absolute Rank Shift** | `16.7040` | `≤ 15.0` | ⚠️ Review |
| **Median Absolute Rank Shift** | `16.8421` | — | — |
| **P95 Absolute Rank Shift** | `31.8060` | — | — |
| **Kendall Tau** | `0.6467` | `≥ 0.60` | ✅ Pass |
| **Spearman Rho** | `0.7902` | `≥ 0.65` | ✅ Pass |
